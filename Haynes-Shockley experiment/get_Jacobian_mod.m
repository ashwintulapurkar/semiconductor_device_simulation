...
Rn=(n.*p-(ni/N_ni)^2)./den_Rn; Rn=Rn-GL*(tau1/N1);  %added effect of light
...
M1_dash=M1-(2*tau1/(delta_t))*eye(Np); %see eqn 6.8a
...
M2_dash=M2-(2*tau2/(delta_t))*eye(Np);  %see eqn 6.8b
