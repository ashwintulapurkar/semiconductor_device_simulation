...
%end calculate electric field dependent mobility. Derivative of mobility is required for Jacobian
...
J2_11=-diag(dRn_by_dn); %eqn 3.16

J2_12=-diag(dRn_by_dp); %eqn 3.16
...
J2_22=-diag(dRp_by_dp);  %eqn 3.16

J2_21=-diag(dRp_by_dn);  %eqn 3.16
...
%%%% Poisson
J2_31=-(N1/N)*eye(Np);   %eqn 3.16
J2_32=(N2/N)*eye(Np);  %eqn 3.16
rho_tilda=doping_profile-n*(N1/N)+p*(N2/N); %eqn. 3.11 a
%%%%%%%%%%%%%%%%%

J1=blkdiag(M1,M2,M3);   %eqn 3.16
J2=[J2_11,J2_12,J2_13; J2_21,J2_22,J2_23; J2_31,J2_32,zeros(Np,Np)];   %eqn 3.16
Vbdy=t_poi*[V_L,zeros(1,Np-2),V_R];     %eqn. 3.13 and 3.14
bdy=[nbdy,pbdy,Vbdy];
f=J1*[n,p,V]'-[Rn,Rp,-rho_tilda]'+bdy';   %eqn 3.14
